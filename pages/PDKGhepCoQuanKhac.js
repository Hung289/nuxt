...
import { Switch, Router, Route, useParams } from "next/router";
import {
  Container,
  Modal,
  Row,
...
const PDKGhepCoQuanKhac = (props) => {
  ...
  const { user } = props;
  const [CoQuanGhep, setCoQuanGhep] = useState([]);
  useEffect(() => {
  ...
  const LoadFileDangKy = (id) => {
    dangKyHienTangService.LoadFileKhacDK(id).then((rs) => {
      if (rs.Status) {
        setFileDK(rs.Data);
      }
    });
  ...
  const ChangeCoQuanGhep = (coquan) => {
    setCoQuanGhep(coquan);
  };
            ...
            <div className="row" key={key}>
              <div className="col-md-11 col-sm-11">
                <div className="row">
                  ...
                  <div className="form-group col-md-2 col-sm-2">
                    <label htmlFor="nhomMauNguoiThan">Nhóm máu ABO</label>
        ...
        <div className="col-sm-12">
          ...
          <div>
            <div className="Bold20">
              Tổ phụ trách: Tiếp nhận đăng ký cần ghép {IsDone.data.TenCoQuan}
            </div>
            <div className="paddingleft10">
              ...
              <div className="alert alert-warning">
                <div>
                  Để hoàn tất quá trình đăng ký vui lòng tải xuống đơn đăng ký
          ...
          <div className="pdk-hien-tieude">XEM LẠI KẾT QUẢ ĐĂNG KÝ</div>
          ...
          <Col md={12}>
            <div className="grid-container" id="boxTangGrid">
              <Button
                variant=""
                type="submit"
                onClick={() => ChangeCoQuanGhep("tim")}
              >
                <div
                  className="grid-item"
                  style={{
                    border: Select === "tim" ? "2px red solid" : "none",
                  }}
                >
              ...
              <Button
                variant=""
                type="submit"
                onClick={() => ChangeCoQuanGhep("phoi")}
              >
                <div
                  className="grid-item"
                  style={{
                    border: Select === "phoi" ? "2px red solid" : "none",
                  }}
                >
              ...
              <Button
                variant=""
                type="submit"
                onClick={() => ChangeCoQuanGhep("gan")}
              >
                <div
                  className="grid-item"
                  style={{
                    border: Select === "gan" ? "2px red solid" : "none",
                  }}
                >
              ...
              <Button
                variant=""
                type="submit"
                onClick={() => ChangeCoQuanGhep("giacmac")}
              >
                <div
                  className="grid-item"
                  style={{
                    border: Select === "giacmac" ? "2px red solid" : "none",
                  }}
                >
              ...
              <Button
                variant=""
                type="submit"
                onClick={() => ChangeCoQuanGhep("tuy")}
              >
                <div
                  className="grid-item"
                  style={{
                    border: Select === "tuy" ? "2px red solid" : "none",
                  }}
                >
                  <img src="/images/bophan_18-26.gif" alt="" />
              ...
              <Button
                variant=""
                type="submit"
                onClick={() => ChangeCoQuanGhep("ruot")}
              >
                <div
                  className="grid-item"
                  style={{
                    border: Select === "ruot" ? "2px red solid" : "none",
                  }}
                >
              ...
              <Button
                variant=""
                type="submit"
                onClick={() => ChangeCoQuanGhep("da")}
              >
                <div
                  className="grid-item"
                  style={{
                    border: Select === "da" ? "2px red solid" : "none",
                  }}
                >
              ...
              <Button
                variant=""
                type="submit"
                onClick={() => ChangeCoQuanGhep("chithe")}
              >
                <div
                  className="grid-item"
                  style={{
                    border: Select === "chithe" ? "2px red solid" : "none",
                  }}
                >
                  <img src="/images/bophan_31-33.gif" alt="" />
          ...
          <Row>
            <Formik
              ...
              initialValues={{
                ...
                lyDoKhac: "",
                choGhepBoPhan: CoQuanGhep.CoQuanGhep,
                choGhepBenh: "",
                choGhepBVDieuTri: "",
                email: "",
                NhiemCovid: false,
              ...
              onSubmit={(values) => {
                ...
                const ObjSave = {
                  dangKyChoGhepThanCreateVM: {
                    ...values1,
                    typePhieuDKGhepTang: CoQuanGhep.CoQuanGhep,
                  },
                  ...
                  <div>
                    <div className="pdk-hien-tieude">
                      <div className="headerClientPage">
                        ...
                        {TypeBoPhanConstant.GetName(CoQuanGhep.CoQuanGhep)} TỪ
                        NGƯỜI HIẾN CHẾT NÃO - NGỪNG TUẦN HOÀN
                      </div>
                    </div>
                      ...
                      <div className="form-row">
                        <div className="form-group col-md-6">
                          <label htmlFor="ngayPhatHienSuyThan">
                            2. Phát hiện suy{" "}
                            {TypeBoPhanConstant.GetName(CoQuanGhep.CoQuanGhep)}
                          </label>
                          <Field
                            type="date"
                      ...
                      <div>
                        ...
                        >
                          <span>
                            ...
                            , có chỉ định ghép{" "}
                            {TypeBoPhanConstant.GetName(CoQuanGhep.CoQuanGhep)}.
                            Tôi đã được các bác sĩ phụ trách giải thích rõ về
                            các bước thực hiện đánh giá tình trạng sức khỏe
                            chung, thực hiện quá trình tuyển chọn, thời gian chờ
                            đợi, tác dụng phụ của thuốc ức chế miễn dịch điều
                            trị sau ghép{" "}
                            {TypeBoPhanConstant.GetName(CoQuanGhep.CoQuanGhep)},
                            chi phí ghép{" "}
                            {TypeBoPhanConstant.GetName(CoQuanGhep.CoQuanGhep)},
                            ...
                            {TypeBoPhanConstant.GetName(CoQuanGhep.CoQuanGhep)}{" "}
                            từ người hiến chết não hay tim ngừng đập tại Bệnh
                            viện Chợ Rẫy, tôi cam kết tuân thủ các quy định
                            trong quá trình điều trị bệnh trước và sau ghép{" "}
                            {TypeBoPhanConstant.GetName(CoQuanGhep.CoQuanGhep)}.
                          </span>
                        </div>
                      </div>
    ...
    return (
      <div className="boxRequestLogin">
        ...
        <div className="center boxBtnLoginRequest">
          <Link
            href="/LoginUser?backurl=PDKGhepCoQuanKhac"
        ...
        {user && user.Token ? (
          <>
            {IsDone.state ? (
              ...
              <>
                {CoQuanGhep !== null ? (
                  <FormGhepCoQuanKhac CoQuanGhep={CoQuanGhep} />
                ) : (
...
PDKGhepCoQuanKhac.getLayout = function getLayout(page) {
  return <LayoutClient>{page}</LayoutClient>;
};
export default connect(mapStateToProps, null)(PDKGhepCoQuanKhac);
